...
1. Either [open](https://github.com/puneetsingh166/tm-load-test/issues/new/choose) or
   [find](https://github.com/puneetsingh166/tm-load-test/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/puneetsingh166/tm-load-test/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
When proposing an architecture decision for the SDK, please start by opening an [issue](https://github.com/puneetsingh166/tm-load-test/issues/new/choose) or a [discussion](https://github.com/puneetsingh166/tm-load-test/discussions/new) with a summary of the proposal. Once the proposal has been discussed and there is rough alignment on a high-level approach to the design, the [ADR creation process](https://github.com/puneetsingh166/tm-load-test/blob/master/docs/architecture/PROCESS.md) can begin. We are following this process to ensure all involved parties are in agreement before any party begins coding the proposed implementation. If you would like to see examples of how these are written, please refer to the current [ADRs](https://github.com/puneetsingh166/tm-load-test/tree/master/docs/architecture).
...
* Architecture Decision Records (ADRs) may be proposed by any contributors or maintainers of the Cosmos SDK,
    ...
    [ADR Creation Process](https://github.com/puneetsingh166/tm-load-test/blob/master/docs/architecture/PROCESS.md)
