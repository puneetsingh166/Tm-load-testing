...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/puneetsingh166/tm-load-test/issues/1988))
    else
...
ldflags = -X github.com/puneetsingh166/tm-load-test/version.Name=sim \
		  -X github.com/puneetsingh166/tm-load-test/version.AppName=simd \
		  -X github.com/puneetsingh166/tm-load-test/version.Version=$(VERSION) \
		  -X github.com/puneetsingh166/tm-load-test/version.Commit=$(COMMIT) \
		  -X "github.com/puneetsingh166/tm-load-test/version.BuildTags=$(build_tags_comma_sep)" \
			-X github.com/tendermint/tendermint/version.TMCoreSemVer=$(TMVERSION)

# DB backend selection
ifeq (cleveldb,$(findstring cleveldb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/puneetsingh166/tm-load-test/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/puneetsingh166/tm-load-test/types.DBBackend=badgerdb
  BUILD_TAGS += badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(COSMOS_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/puneetsingh166/tm-load-test/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(COSMOS_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/puneetsingh166/tm-load-test/types.DBBackend=boltdb
endif
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/puneetsingh166/tm-load-test/types"
	godoc -http=:6060
