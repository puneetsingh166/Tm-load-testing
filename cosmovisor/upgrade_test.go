...
import (
	...
	"github.com/puneetsingh166/tm-load-test/cosmovisor"
)
...
func (s *upgradeTestSuite) TestGetDownloadURL() {
	...
	cases := map[string]struct {
		...
		"follow reference": {
			info: ref,
			url:  "https://github.com/puneetsingh166/tm-load-test/raw/master/cosmovisor/testdata/repo/chain3-zip_dir/autod.zip?checksum=sha256:8951f52a0aea8617de0ae459a20daf704c29d259c425e60d520e363df0f166b4",
		},
