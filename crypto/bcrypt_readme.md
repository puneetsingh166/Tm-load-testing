...
```bash
go test -v --bench github.com/puneetsingh166/tm-load-test/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/puneetsingh166/tm-load-test/crypto/keys/mintkey
...
PASS
ok  	github.com/puneetsingh166/tm-load-test/crypto/keys/mintkey	12.093s
```
