...
- 2021 Feb 24: Remove mentions of `HybridCodec`, which has been abandoned in [#6843](https://github.com/puneetsingh166/tm-load-test/pull/6843).
...
After [extension discussion](https://github.com/puneetsingh166/tm-load-test/issues/6030),
...
```go
import "github.com/puneetsingh166/tm-load-test/codec"
...
message MsgSubmitEvidence {
  bytes submitter = 1
    [
      (gogoproto.casttype) = "github.com/puneetsingh166/tm-load-test/types.AccAddress"
    ];
...
1. https://github.com/puneetsingh166/tm-load-test/issues/4977
2. https://github.com/puneetsingh166/tm-load-test/issues/5444
