...
import (
	...
	snapshottypes "github.com/puneetsingh166/tm-load-test/snapshots/types"
	"github.com/puneetsingh166/tm-load-test/store/cachemulti"
	"github.com/puneetsingh166/tm-load-test/store/iavl"
	sdkmaps "github.com/puneetsingh166/tm-load-test/store/internal/maps"
	"github.com/puneetsingh166/tm-load-test/store/listenkv"
...
func benchmarkMultistoreSnapshot(b *testing.B, stores uint8, storeKeys uint64) {
	b.Skip("Noisy with slow setup time, please see https://github.com/puneetsingh166/tm-load-test/issues/8855.")
