...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/puneetsingh166/tm-load-test/types/errors.Wrap",
		"github.com/puneetsingh166/tm-load-test/types/errors.Wrapf",
		"github.com/puneetsingh166/tm-load-test/types/errors.WithType",
