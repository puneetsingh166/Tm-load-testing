...
import (
	...
	types1 "github.com/puneetsingh166/tm-load-test/crypto/types"
	...
	signing "github.com/puneetsingh166/tm-load-test/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/puneetsingh166/tm-load-test/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/puneetsingh166/tm-load-test/types.Coins" json:"amount"`
