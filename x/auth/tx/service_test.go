...
import (
	...
	"github.com/puneetsingh166/tm-load-test/testutil/rest"
	...
	"github.com/puneetsingh166/tm-load-test/types/query"
	...
	authtest "github.com/puneetsingh166/tm-load-test/x/auth/client/testutil"
	bankcli "github.com/puneetsingh166/tm-load-test/x/bank/client/testutil"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/puneetsingh166/tm-load-test/issues/8680
				// ref: https://github.com/puneetsingh166/tm-load-test/issues/8681
