...
type Supply struct {
	Total github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/puneetsingh166/tm-load-test/types.Coins" json:"total"`
}
