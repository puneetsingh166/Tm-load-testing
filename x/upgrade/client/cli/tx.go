...
import (
	...
	"github.com/puneetsingh166/tm-load-test/x/gov/client/cli"
	gov "github.com/puneetsingh166/tm-load-test/x/gov/types"
	"github.com/puneetsingh166/tm-load-test/x/upgrade/types"
)
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/puneetsingh166/tm-load-test/tree/master/cosmovisor",
